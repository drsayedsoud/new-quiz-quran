...
import { getDatabase, ref, set, get, child, update, onValue, remove } from "https://www.gstatic.com/firebasejs/10.9.0/firebase-database.js";
...
export { db, ref, set, get, child, update, onValue, remove };
